...
namespace DTAClient.Online
{
    ...
    {
        private const int MAX_RECONNECT_COUNT = 3; // Default: 8
        private const int RECONNECT_WAIT_DELAY = 1000; // Default: 4000
        private const int ID_LENGTH = 9;
        private const int MAXIMUM_LATENCY = 100; // Default: 400
